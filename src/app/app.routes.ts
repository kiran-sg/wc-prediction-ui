...
import { authGuard, adminGuard, tournamentGuard } from './guards/auth.guard';
...
export const routes: Routes = [
  ...
  { path: 'tournament', loadComponent: () => import('./components/tournament-predict/tournament-predict.component').then(m => m.TournamentPredictComponent), canActivate: [tournamentGuard] },
